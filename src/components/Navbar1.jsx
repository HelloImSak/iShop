...
const Navbar1 = () => {
  return (
    <nav class="bg-white border-gray-200 dark:bg-gray-900 dark:border-gray-700">
      <div class="">
        <p className="text-small bg-primary text-white p-1 flex justify-center items-center">Get 30% off when you spend over $200.</p>
      </div>
      <div class="flex flex-wrap items-center justify-between mx-[50px] py-2">
